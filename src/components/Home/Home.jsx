...
import ReceiveMessage from "../Notificaciones/ReceiveMessage";
import SendMessage from "../Notificaciones/SendMessage";
                      ...
                      <Card className="card-stats upper bg-default">
                        <CardBody>
                          <Row>
                            <Col md="4" xs="5">
                              <div className="icon-big text-center icon-warning">
                                <i className="tim-icons icon-zoom-split text-info"></i>{" "}
                              </div>
                            </Col>
                            <Col md="8" xs="7">
                              <div className="numbers">
                          ...
                          <Row>
                            ...
                            <Col md="8" xs="7">
                              <div className="numbers">
                                ...
                                <p />
                                <p className="card-category">
                                  De los diangosticos tempranos son resueltos
                                  con exito
                                </p>
                              </div>
                            </Col>
                          ...
                          <Row>
                            ...
                            <Col md="8" xs="7">
                              <div className="numbers">
                                ...
                                <p />
                                <p className="card-category">
                                  Es la taza a la que desciende si no se detecta
                                  a tiempo
                                </p>
                              </div>
                            </Col>
